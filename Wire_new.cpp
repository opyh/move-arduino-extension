...
uint8_t TwoWireSpecialEdition::rxBuffer[BUFFER_LENGTH];
uint16_t TwoWireSpecialEdition::rxBufferIndex = 0;
uint16_t TwoWireSpecialEdition::rxBufferLength = 0;
...
uint8_t TwoWireSpecialEdition::requestFrom(uint8_t address, uint8_t quantity)
{
...
uint8_t TwoWireSpecialEdition::requestFrom(int address, int quantity)
{
...
int TwoWireSpecialEdition::available(void)
{
...
// slave rx event callback
// or after requestFrom(address, numBytes)
int TwoWireSpecialEdition::peek(void)
{
  int value = -1;
...
void TwoWireSpecialEdition::flush(void)
{
  // XXX: to be implemented.
}

// behind the scenes function that is called when data is received
void TwoWireSpecialEdition::onReceiveService(uint8_t* inBytes, int numBytes)
{
...
void TwoWireSpecialEdition::onReceive( void (*function)(int) )
{
...
TwoWireSpecialEdition WireSpecialEdition = TwoWireSpecialEdition();
